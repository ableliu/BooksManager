...
public class AddBook extends AppCompatActivity {
    ...
    private void addBook() {
        ...
        BookDataSource dataSource = BookDataSource.getInstance(mContext);
        if (!isEdit) {
            if (null != dataSource.getData(code)) {
        ...
        if (isEdit) {
            ...
            dataSource.updateBook(mBook.getId(), mCurrentCid, code, name, publisher, author,
                    new BaseDataSource.HandlerCallBack() {
                        @Override
            ...
            dataSource.saveData(book, new BaseDataSource.HandlerCallBack() {
                @Override
                public void onSuccess() {
